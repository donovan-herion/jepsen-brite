                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group position-relative">
                                                ...
                                                <input type="text" class="form-control pl-5" placeholder="First Name" name="FirstName" value="<?php if (isset($FirstName)) {
                                                                                                                                                    echo $FirstName;
                                                                                                                                                } ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group position-relative">
                                                ...
                                                <i class="mdi mdi-account ml-3 icons"></i>
                                                <input type="text" class="form-control pl-5" placeholder="Last Name" name="LastName" value="<?php if (isset($LastName)) {
                                                                                                                                                echo $LastName;
                                                                                                                                            } ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group position-relative">
                                                ...
                                                <i class="mdi mdi-account ml-3 icons"></i>
                                                <input type="email" class="form-control pl-5" placeholder="Email" name="Email" value="<?php if (isset($Email)) {
                                                                                                                                            echo $Email;
                                                                                                                                        } ?>">
                                            </div>
                                        </div>
